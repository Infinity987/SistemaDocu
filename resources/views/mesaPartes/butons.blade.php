<div class="d-grid gap-2 d-md-flex justify-content-md-center" aria-label="Basic mixed styles example">
  <form action="{{ route('documentario.mesapar.showEmitido', $iddocumentos) }}" method="get">
    @if ($id_estado == 1)
      <button type="submit" class="btn btn-block bg-gradient-danger btn-sm" data-toggle="modal" data-target="#editardocu">
