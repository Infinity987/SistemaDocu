        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('documentario.enviardocumentos.responder') }}" method="POST"
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            ...
                            if (emisor === 'Docente') {
                                ...
                                colorTexto = "#3e2723";
                                fontStyle = "font-weight-semibold";
                            }

                            return `
                                    <div style="color: ${colorTexto}; display: flex; align-items: center;" class="${fontStyle}">
