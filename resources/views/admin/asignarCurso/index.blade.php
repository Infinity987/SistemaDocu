...
@section('title', 'Asignar Docente curso')
        ...
        <div class="callout callout-danger mb-0 shadow">
            <section class="content-header p-0">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h1><i class="fa fa-users" aria-hidden="true"></i> - Asignar docente curso</h1>
                        </div>
                        <div class="col-sm-6">
...
@section('content')
    @can('asignarCurso.index')
        @livewire('Admin.asignar-docente')
    @endcan
@stop
    ...
    <script>
        ...
        document.addEventListener('livewire:init', () => {
            ...
            window.addEventListener('confirmarEliminacion', event => {
                const iddocentecurso = event.detail.iddocentecurso;

                Swal.fire({
                    title: '¿Estás seguro?',
                    text: "¿Deseas quitar al docente asignado de este curso?",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.dispatch('quitarDocente', {
            ...
            window.addEventListener('docente-quitado', () => {
                Swal.fire({
                    title: '¡Listo!',
                    text: 'El docente fue quitado correctamente.',
                    icon: 'success',
                    timer: 2000,
            ...
            // Confirmación al guardar todo
            window.addEventListener('mostrar-confirmacion', () => {
                Swal.fire({
                    title: '¿Estás seguro?',
                    text: "¿Deseas guardar estas asignaciones?",
                    icon: 'question',
                    showCancelButton: true,
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('confirmarGuardado');
                    }
                });
            });

            window.addEventListener('mensaje-exito', event => {
                Swal.fire({
                    title: '¡Guardado!',
