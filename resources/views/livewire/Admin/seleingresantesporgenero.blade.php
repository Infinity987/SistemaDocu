          ...
          <div class="form-group">
            <CENter>
              <div class="bg-lightblue disabled color-palette">
                <h2>TABLA DE REPORTE INGRESANTES POR GENERO Y CARRERA</h2>
              </div>
            </CENter>
                ...
                <tbody>
                    @foreach ($carreras as $reporte1)
                        <tr>
                            ...
                            <td width="150px">
                                <input type="text" class="form-control" id="numerohombre" name="numerohombre" value="{{ $reporte1->Ingresantes_Hombres }}" readonly>
                            </td>
                            <td width="150px">
                                <input type="text" class="form-control" id="numeromujer" name="numeromujer" value="{{ $reporte1->Ingresantes_Mujeres }}" readonly>
                            </td>
                            <td width="150px">
