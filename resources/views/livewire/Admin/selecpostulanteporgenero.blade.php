          ...
          <div class="form-group">
            <CENter>
              <div class="bg-lightblue disabled color-palette">
                <h2>TABLA DE REPORTE POSTULANTES POR GENERO Y CARRERA</h2>
              </div>
            </CENter>
                ...
                <tbody>
                    @foreach ($carreras as $reporte1)
                        <tr>
                            ...
                            <td width="150px">
                                <input type="text" class="form-control" id="numerohombre" name="numerohombre" value="{{ $reporte1->Numero_de_Hombres }}" readonly>
                            </td>
                            <td width="150px">
                                <input type="text" class="form-control" id="numeromujer" name="numeromujer" value="{{ $reporte1->Numero_de_Mujeres }}" readonly>
                            </td>
                            <td width="150px">
                                <input type="text" class="form-control" id="numerocarre" name="numerocarre" value="{{ $reporte1->Numero_de_Inscritos }}" readonly>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
