...
@endif
                            ...
                            @if ($id_depen == 2)
                                <div class="mb-3">
                                    ...
                                    @error('tramite_documento') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="p-3 bg-white border rounded shadow-sm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" wire:model="asunto" class="form-control" placeholder="Resumen breve del documento...">
                            ...
                            <div class="mb-3">
                                ...
                                @error('recomendaciones') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-6 mt-3 mt-md-0">
                                    @if ($entregaOpciones == 2 || $entregaOpciones == 3)
                                        ...
                                        <input type="file" wire:model="archivo_virtual" class="form-control shadow-sm">
                                        ...
                                        @if ($archivo_virtual)
                                            <div class="mt-2 small text-success">
                                                <i class="fas fa-file-pdf"></i> Listo: {{ $archivo_virtual->getClientOriginalName() }}
                                            </div>
                                        @endif
                                    @endif
                                </div>
