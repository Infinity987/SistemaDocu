        ...
        @if (!is_null($selectedProvincia))
            <div class="col-sm-4 mb-3">
                <div class="form-group">
                    ...
                    <select id="distrito_domicilio" name="distrito_domicilio" wire:model="selectedDistrito" wire:change="handleDistritoChange($event.target.value)"  class="form-control" required>
