...
class ReporteNotasSemestrePdf extends Component
{
     ...
     public function handleCarreraChange($carreraselect)
    {
        ...
        $this->malla = DB::connection('mysql_segunda')->table('malla_curricular')
            ...
            ->select('idmalla_curricular',                 
                     'nombre_malla_curricular')
    ...
    {
        \Log::info("malla seleccionado: {$selectedMalla}");
    ...
    {
        return view('livewire.reporte-notas-semestre-pdf');
    }
}
