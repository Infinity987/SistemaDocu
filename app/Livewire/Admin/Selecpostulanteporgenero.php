...
class Selecpostulanteporgenero extends Component
{
    ...
    public function handleModalidadChange($modalidad)
{
    ...
    $this->carreras = DB::table('inscripcion')
        ...
        ->select(
            ...
            DB::raw('SUM(CASE WHEN postulante.genero_postulante = "Hombre" THEN 1 ELSE 0 END) AS Numero_de_Hombres'),
            DB::raw('SUM(CASE WHEN postulante.genero_postulante = "Mujer" THEN 1 ELSE 0 END) AS Numero_de_Mujeres'),
    ...
    {
        return view('livewire.Admin.selecpostulanteporgenero');
    }
}
